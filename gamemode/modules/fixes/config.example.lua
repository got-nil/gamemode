local banned, nodamage, nocolide, nopickup = 1, 2, 3, 4
return {
    realm = "server",
    shared = {
        "Modules"
    ...
    config = {
        ...
        -- Allow for rule enums to be applied to entities allowing for ents to be:
        --  blacklisted, damage disabled, collision disabled and pickup disabled.
        Entities = {
            ...
            ["keypad"] = {nodamage, nocolide, nopickup}
